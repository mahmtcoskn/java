...
public class EChild extends DParent {
    ...
    @Override
    public void method2() {
        System.out.println("parent class daki mecburi override edilecek method2 yi override ettik");
    }
    ...
    public static void main(String[] args) {
        ...
        chld1.method2();  // parent class'daki mecburi override edilecek method2'yi override ettik
